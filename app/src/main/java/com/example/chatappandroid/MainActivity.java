...
public class MainActivity extends AppCompatActivity {
    private final static int LOGIN_REQUEST_CODE = 2912;
    ...
    private void init(){
        ...
        listener = myFirebaseAuth -> Dexter.withContext(this)
            ...
            public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                if(multiplePermissionsReport.areAllPermissionsGranted()){
                    ...
                    Toast.makeText(MainActivity.this, "Por favor habilita todos los permisos", Toast.LENGTH_SHORT).show();
            }
